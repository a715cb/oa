...
class AuthService extends BaseService
{
    ...
    public function login(string $username, string $password): array
    {
        ...
        // 获取用户信息
        $user = User::field('status,id,password,must_change_password')->getByUsername($username);
        ...
        $tokens = $this->jwtAuth->generateToken(['id' => $user->id]);
        
        // 添加必须修改密码的标志
        $tokens['must_change_password'] = $user->must_change_password ?? true;
