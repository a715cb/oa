...
class BaseValidate extends Validate
{
    /**
     * 验证是否是有效的数字(小数、负数、整数)
     * @param mixed $value 验证内容
     * @param mixed $rule 验证规则
     * @param array $data 数据
     * @param string $field 验证的字段名
     * @return bool
     */
    protected function validNumber($value, $rule, array $data, string $field): bool
    {
     ...
     * @return bool
     */
    protected function alphaPwd(string $value, $rule, array $data, string $field): bool
    {
     ...
     * @return bool
     */
    protected function notChs(string $value, $rule, array $data, string $field): bool
    {
    ...
    /**
     * 切面验证接收到的参数
     * @param string|null $scene 场景验证
     * @param string $field 接收的请求参数，为空接收所有
     * @param array $validateData 验证参数，可追加和覆盖掉接收的参数
     * @return array
     * @throws ValidateException
     */
    public function validated(?string $scene = null, string $field = '', array $validateData = []): array
    {
        //接收参数
