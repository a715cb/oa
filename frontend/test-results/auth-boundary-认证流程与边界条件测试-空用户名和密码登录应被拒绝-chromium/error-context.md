...
- Name: auth-boundary.spec.ts >> 认证流程与边界条件测试 >> 空用户名和密码登录应被拒绝
- Location: e2e\auth-boundary.spec.ts:4:3
      ...
      - generic [ref=e51]:
        - generic [ref=e53]:
          ...
          - generic [ref=e55]:
            - img "lock" [ref=e57]:
              - img [ref=e58]
            - textbox "请输入密码" [ref=e60]
            - img "eye-invisible" [ref=e62] [cursor=pointer]:
              - img [ref=e63]
        - alert [ref=e67]:
          - generic [ref=e68]: 请输入密码
      - generic [ref=e69]:
        - generic [ref=e70] [cursor=pointer]:
          - checkbox "记住账号" [ref=e72]
          - generic [ref=e74]: 记住账号
        - generic [ref=e75] [cursor=pointer]: 忘记密码？
      - button "登 录" [active] [ref=e81] [cursor=pointer]:
        - generic [ref=e82]: 登 录
    - generic [ref=e83]:
      - paragraph [ref=e84]: Copyright © 2026 OnLine OA Team
      - paragraph [ref=e85]: 粤ICP备2026000000号
```
