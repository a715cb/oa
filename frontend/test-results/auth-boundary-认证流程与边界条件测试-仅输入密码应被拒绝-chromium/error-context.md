...
- Name: auth-boundary.spec.ts >> 认证流程与边界条件测试 >> 仅输入密码应被拒绝
- Location: e2e\auth-boundary.spec.ts:20:3
    ...
    - generic [ref=e32]:
      ...
      - generic [ref=e53]:
        ...
        - generic [ref=e55]:
          - img "lock" [ref=e57]:
            - img [ref=e58]
          - textbox "请输入密码" [ref=e60]: "123456"
          - img "eye-invisible" [ref=e62] [cursor=pointer]:
            - img [ref=e63]
      - generic [ref=e66]:
        - generic [ref=e67] [cursor=pointer]:
          - checkbox "记住账号" [ref=e69]
          - generic [ref=e71]: 记住账号
        - generic [ref=e72] [cursor=pointer]: 忘记密码？
      - button "登 录" [active] [ref=e78] [cursor=pointer]:
        - generic [ref=e79]: 登 录
    - generic [ref=e80]:
      - paragraph [ref=e81]: Copyright © 2026 OnLine OA Team
      - paragraph [ref=e82]: 粤ICP备2026000000号
```
