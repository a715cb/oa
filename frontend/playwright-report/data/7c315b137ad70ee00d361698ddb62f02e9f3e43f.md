...
- Name: xss-protection.spec.ts >> SEC-008: XSS 跨站脚本防护测试 >> 部门搜索高亮应转义 HTML
- Location: e2e\xss-protection.spec.ts:29:3
...
Call log:
  - waiting for locator('input[placeholder*="搜索"]') to be visible
